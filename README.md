...
> **⚠️ Important:** Please download the mod from the [latest release](https://github.com/Per88888/DedicatedRenderDistance/releases/latest), not from the files in this repository.
...
3. Place the `DedicatedRenderDistance2.0.large._P.pak` file in the `Paks` folder alongside the existing `.pak` files.
